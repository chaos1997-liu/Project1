public class TXTReceiptBuilder implements IReceiptBuilder {
    ...
    public void appendPurchase(PurchaseModel purchase) {
        ...
        sb.append("Purchase Customer ID: ").append(purchase.mCustomerID).append("\n");
        sb.append("Purchase Product ID: ").append(purchase.mProductID).append("\n");
        sb.append("Purchase Price: ").append(purchase.mPrice).append("\n");
